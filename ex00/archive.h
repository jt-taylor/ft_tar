...
/*   Updated: 2020/02/16 18:51:18 by jtaylor          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	path_to_tar(char *path, struct *s_tar);

/*
** Hash table
*/

int						table_free(t_hashnode **table);
int						table_checkadd(t_hashnode **table, ino_t my_ino);
